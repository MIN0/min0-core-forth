...
公式repositoryは <https://github.com/MIN0/min0-core-forth> です。公開候補`v0.1.0-rc.1`を
再取得してGate C監査を完了した後、公式1stリリースを`v0.1.0`として確定しました。
...
これは今後の互換性説明をより明確にするための作業であり、`0.1.0`の公開を妨げる項目ではありません。
