...
リリースタグ：`v0.1.2`<br>
リリースノート：**[0.1.2文書整備版](docs/RELEASE_NOTES_0.1.2_JP.md)**
...
- 独立した英語版／日本語版の入口とGuided Viewer
- 起動時の全61ワードと動的`DEFER` familyを説明するポケットリファレンス
- 目的から選べるFORTH設計資料・学習資料の案内
...
公開と独立再取得までの証拠は**[0.1.2リリース監査](docs/RELEASE_AUDIT_0.1.2_JP.md)**に記録しています。
